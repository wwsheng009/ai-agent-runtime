...
func TestHandleCommand_DebugPrintsSessionArtifactsAndRuntimeState(t *testing.T) {
	...
	expectedFragments := []string{
		...
		fmt.Sprintf("%-18s %s", "Interaction:", "prompt_visible=true prompt_paste_active=true thinking_active=true streaming_active=true reasoning_active=true gap_prewritten=true shutdown=false stream_stable_queued=0 stream_prefix_enqueued=0 stream_prefix_emitted=0 stream_transcript_blocks=0 stream_transcript_bytes=0 stream_final_divergence=append"),
