...
func TestGetRuntimeStatus_RequiresAdmin(t *testing.T) {
	...
	assert.Contains(t, authorizedRec.Body.String(), `"tool_efficiency"`)
	assert.Contains(t, authorizedRec.Body.String(), `"preflight"`)
	assert.Contains(t, authorizedRec.Body.String(), `"disposition_replays"`)
