...
- [install.md](./install.md)
  - Installation, configuration loading order, starter config bootstrap, `aicli init`, `aicli login`, default `aicli` / `aicli chat` startup, session/resume flags, MCP overview, shell/background notes, current chat slash commands, and subagent difficulty routing dry-run/debug notes.
- [exec.md](./exec.md)
...
- [../skill_runtime/aicli_skills_usage.md](../skill_runtime/aicli_skills_usage.md)
  - How `aicli` / `aicli chat` exposes and routes skills.
