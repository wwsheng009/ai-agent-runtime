...
> **拆分进度（2026-09-11）**：第 5 项 `types/runtime.ts`(1692)、第 6 项 `components/workspace/workspace-sidebar.tsx`(1560)、第 4 项 `lib/workspace-thread-state.ts`(1815) + 随源第 16 项测试(800)、第 13 项 `lib/trajectory/trajectory-reducer.ts`(831) + 随源第 34 项测试(537)、第 10 项 `pages/usage-analytics-page.tsx`(974)、第 8 项 `hooks/workspace/use-workspace-agent-chat-turn.ts`(1337)、第 7 项 `components/workspace/settings/runtime-provider-groups-domain-editor.tsx`(1358)、第 9 项 `components/workspace/settings/runtime-provider-domain-editor.tsx`(1187)、第 11 项 `pages/logs-page.tsx`(893)、第 12 项 `components/workspace/runtime-teams/runtime-team-dispatch-panel.tsx`(846)、第 14 项 `components/workspace/runtime-teams/runtime-team-details-panel.tsx`(812)、第 15 项 `components/workspace/settings/runtime-agent-routing-domain-editor.tsx`(807)、第 17 项 `components/workspace/settings/runtime-rate-limit-domain-editor.tsx`(770)、第 18 项 `hooks/workspace/use-session-backtrack.ts`(744)、第 19 项 `components/workspace/runtime-teams/use-runtime-team-dispatch.ts`(743)、第 20 项 `components/workspace/message-list.tsx`(719)、第 21 项 `components/workspace/settings/runtime-retry-domain-editor.tsx`(715)、第 22 项 `components/workspace/workspace-shell.tsx`(695)、第 23 项 `components/workspace/runtime-teams.tsx`(693)、第 24 项 `components/workspace/runtime-teams/team-details-panel.tsx`(683)、第 25 项 `components/workspace/runtime-teams/shared.ts`(628)、第 26 项 `components/workspace/message-markdown.tsx`(625)、第 27 项 `components/workspace/artifact-panel.tsx`(618)、第 28 项 `components/workspace/artifact-panel-checkpoint-surface.tsx`(613)、第 30 项 `components/workspace/runtime-teams/dispatch-console.tsx`(575)、第 35 项 `components/workspace/artifact-detail-dialog.tsx`(534)、第 32 项 `components/workspace/settings/runtime-routing-domain-editor.tsx`(565)、第 40 项 `components/workspace/settings/runtime-transformer-domain-editor.tsx`(508)、第 29 项 `components/workspace/settings/appearance-settings-page.tsx`(596)、第 31 项 `components/workspace/settings/harness-settings-page.tsx`(568)、第 41 项 `components/workspace/settings/runtime-provider-queue-domain-editor.tsx`(504)、第 38 项 `components/workspace/settings/runtime-agent-routing-domain-utils.ts`(514)、第 1 项 `components/workspace/settings/backend-config-settings-page.tsx`(3932)、第 33 项 `data/mock.ts`(539)、第 36 项 `hooks/workspace/use-runtime-sessions-data.ts`(523) 已完成拆分（→ `types/runtime/` 14 个域模块；`lib/thread-state/` 10 个职责模块 + 4 个同源测试 + 共享夹具；`lib/trajectory/trajectory-reducer/` 4 个层次模块 + 3 个同源测试 + 共享夹具；`pages/usage-analytics/` 4 个模块；`hooks/workspace/agent-chat-turn/` 10 个模块；`components/workspace/settings/runtime-provider-domain-editor/` 6 个模块；`pages/logs-page/` 5 个模块；`components/workspace/runtime-teams/runtime-team-dispatch-panel/` 8 个模块；`components/workspace/runtime-teams/runtime-team-details-panel/` 10 个模块；`components/workspace/settings/runtime-agent-routing-domain-editor/` 9 个模块；`components/workspace/settings/runtime-rate-limit-domain-editor/` 7 个模块；`hooks/workspace/session-backtrack/` 4 个模块；`components/workspace/runtime-teams/use-runtime-team-dispatch/` 4 个模块；`components/workspace/message-list/` 6 个模块；`components/workspace/settings/runtime-retry-domain-editor/` 5 个模块、`components/workspace/workspace-shell/` 6 个模块、`components/workspace/runtime-teams/` 6 个模块、`components/workspace/runtime-teams/team-details-panel/` 9 个模块、`components/workspace/runtime-teams/shared/` 5 个域模块、`components/workspace/message-markdown/` 5 个模块、`components/workspace/artifact-panel/` 4 个模块、`components/workspace/artifact-panel-checkpoint-surface/` 4 个模块、`components/workspace/workspace-sidebar/` 14 个模块、`components/workspace/runtime-teams/dispatch-console/` 8 个模块、`components/workspace/artifact-detail-dialog/` 6 个模块、`components/workspace/settings/runtime-routing-domain-editor/` 5 个模块、`components/workspace/settings/runtime-transformer-domain-editor/` 6 个模块、`components/workspace/settings/appearance-settings-page/` 9 个模块、`components/workspace/settings/harness-settings-page/` 7 个模块、`components/workspace/settings/runtime-provider-queue-domain-editor/` 6 个模块、`components/workspace/settings/runtime-agent-routing-domain-utils/` 7 个模块（类型 / 摘要读取 / 写入构建 / 能力探测 / 选项 / 健康分析 / 文本工具）、`components/workspace/settings/backend-config-settings-page/` 48 个模块（core 三层 hook / 15 个域工厂 / 7 个 section / 16 个模式 section / 7 个支撑模块）、`data/mock/` 3 个模块（类型 / 模板串资产 / `initialThreads` 夹具）、`hooks/workspace/runtime-sessions-data/` 7 个模块（类型 / 归一化 / 排序与摘要 / 存储键与缓存读写 / 重试退避 / 用户选择 / 加载合并），均见 §9.3 实施记录）；表中行数为拆分前快照，其余 4 项待推进（首批 20 项全部完成；第 2 批 8 项全部完成；第 3 批 10 项全部完成；第 4 批 2/4 项完成）。
