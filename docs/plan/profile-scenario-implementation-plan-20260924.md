...
> ⑨ 时点勘误（2026-09-25）：本文件中 2026-09-24 的历史变更记录（Batch 6 相关各条与当日完成度审计条）里出现的“FR-12 / FR-13 / FR-14 待排期 / 仍 P2 / 唯一未实施项 = FR-14 / 按 Q12 后置”等表述均为**当时时点状态**，其后分别由 FR-12（随 Batch 8，2026-09-24 核实回填）、FR-13（slice 2/2b，2026-09-24）、FR-14 第一阶段（2026-09-25，见本条记录）落地。**当前状态**以本文件顶部 P2 段、Batch 6 段落地状态句、§3.1 V10 行、§4 任务卡 Q12 行、附录 P 跟踪表 Batch 6 行与本条为准；历史条目按原样保留以存证时点判断。
