...
export function CaseStudySection() {
  ...
  const caseStudies = [
    ...
    {
      accent: "from-accent-gold/35 via-[#201812] to-transparent",
    ...
    {
      accent: "from-accent-teal/28 via-[#091717] to-transparent",
    ...
    {
      accent: "from-accent-teal/22 via-[#0d1117] to-transparent",
    ...
    {
      accent: "from-accent-gold/25 via-[#160f0f] to-transparent",
