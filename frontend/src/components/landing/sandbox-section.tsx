  ...
  return (
    ...
    >
      <div className="grid gap-4 lg:grid-cols-[1.05fr_0.95fr]">
        <div className="overflow-hidden rounded-[1.9rem] border border-border bg-[var(--terminal-shell-bg)] shadow-[0_24px_80px_rgba(0,0,0,0.24)]">
        ...
        <div className="flex flex-col justify-between rounded-[1.9rem] border border-border bg-[var(--panel-soft-bg)] p-6">
          <div>
            <div className="flex items-center gap-3 text-sm font-semibold text-accent-secondary">
          ...
          <div className="mt-8">
            <div className="mb-4 flex items-center gap-3 text-sm font-semibold text-accent-primary">
            ...
            <div className="flex flex-wrap gap-3">
              {sandboxTags.map((tag) => (
                <span
                  key={tag}
                  className="inline-flex items-center gap-2 rounded-full border border-border bg-surface-soft px-4 py-2 text-sm text-foreground"
                >
