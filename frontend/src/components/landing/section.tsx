...
export function Section({
  ...
  return (
    <section className={cn("container-shell py-10 sm:py-14", className)}>
      <div className="relative overflow-hidden rounded-[2.25rem] border border-border bg-[var(--section-panel-bg)] px-6 py-10 shadow-[0_24px_90px_rgba(0,0,0,0.16)] backdrop-blur-xl sm:px-10 sm:py-12">
        ...
        <header className="mx-auto flex max-w-4xl flex-col items-center text-center">
          <div className="app-text-11 uppercase tracking-[0.22em] text-accent-secondary">
            {eyebrow}
          </div>
