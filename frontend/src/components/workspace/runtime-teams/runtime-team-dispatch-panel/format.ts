export const dispatchControlClass =
  "w-full rounded-[0.75rem] border border-white/8 bg-black/15 px-3 py-2 text-sm text-foreground outline-none placeholder:text-white/28";

export const dispatchStatusPillClass =
