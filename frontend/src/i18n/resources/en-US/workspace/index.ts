...
import { enWorkspacePanelsFileBrowser } from "./panels-file-browser";
import { enWorkspaceFilePreview } from "./panels-file-preview";
import { enWorkspacePanelsGit } from "./panels-git";
...
export const enWorkspace = {
  ...
  panels: {
    ...
    fileBrowser: enWorkspacePanelsFileBrowser,
    filePreview: enWorkspaceFilePreview,
    git: enWorkspacePanelsGit,
