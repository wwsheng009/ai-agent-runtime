...
import { buildRuntimeInsightRows } from "./logs-page-detail-panel-insights";
  ...
  return (
    <div className="flex-1 space-y-2.5 overflow-y-auto px-3 py-3">
      <div className="rounded-[0.85rem] border border-[var(--border)] bg-[var(--surface-softer)] p-3">
        ...
        <h2
          className="mt-2.5 max-h-20 overflow-hidden break-words text-lg font-semibold leading-6 tracking-[-0.02em]"
          title={selectedEntry.message || selectedEntry.raw_text}
        >
