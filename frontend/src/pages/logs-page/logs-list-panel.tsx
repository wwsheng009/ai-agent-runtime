    ...
    <div className="surface-panel flex min-h-[22rem] flex-col overflow-hidden rounded-[0.95rem] lg:min-h-0">
      <div className="flex items-center justify-between border-b border-border px-3 py-2">
        <div>
          ...
          <div className="app-text-10 text-muted-foreground">
            {t("listSubtitle")}
          </div>
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      active ? "ring-1 ring-accent-primary-border" : "",
                    )}
                  >
      ...
      <div className="grid grid-cols-[4.1rem_2.15rem_minmax(0,1fr)] gap-2 border-b border-border/70 px-3 py-2 font-mono app-text-10 uppercase tracking-[0.16em] text-muted-foreground">
          ...
          <div className="space-y-2">
            {entries.map((entry) => {
              ...
              return (
                ...
                >
                  <div className="pt-0.5 text-right font-mono app-text-10 leading-4 text-muted-foreground">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="mt-0.5 truncate font-mono app-text-10-5 leading-4 text-muted-foreground">
                      {buildEntryMeta(entry) || buildEntrySubtitle(entry, subtitleLabels)}
                    </div>
                    {buildEntryContext(entry) ? (
                      <div className="mt-0.5 truncate app-text-10 leading-4 text-muted-foreground/75">
                        {buildEntryContext(entry)}
                      </div>
                    ) : null}
                  </div>
