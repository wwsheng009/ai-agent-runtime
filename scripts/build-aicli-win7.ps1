<#
.SYNOPSIS
    Backward-compatible wrapper for the Win7 aicli + aicli-console build.

.DESCRIPTION
    Forwards to scripts/build.ps1 with -Tools aicli,aicli-console -Target win7.
    All parameters are passed through unchanged.

.EXAMPLE
    pwsh -File ./scripts/build-aicli-win7.ps1 -Version win7-v1.2.3 -OutputDir dist/win7 -SkipTests
#>
[CmdletBinding()]
param(
    [string]$Version = "",
...
$forwardArgs['Tools'] = 'aicli,aicli-console'
